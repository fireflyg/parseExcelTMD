 ...
 */
public class ReadExcelForWeb {
    public static void excel(File fileForWeb) throws Exception {
        //用流的方式先读取到你想要的excel的文件
        /*FileInputStream fis=new FileInputStream(new File(System.getProperty("user.dir")+"/src/excel.xls"));*/
        FileInputStream fis=new FileInputStream(fileForWeb);
        //解析excel
            ...
            int prefix = 200180;
                ...
                for(int i = 0;i < a.size()-1;i++){
                   ...
                   // generateQRCodeImage.generateQRCodeImage(ecell.getCode(), 350, 350, "D:/twocode2/"+ecell.getNumber()+".png");
                    generateQRCodeImage.generateQRCodeImage(ecell.getCode(), 500, 300, "D:/GBF"+j+"/"+ecell.getNumber()+".png");
                    //将二维码与文字合并
